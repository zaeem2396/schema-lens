...
Quick reference guide for testing Schema Lens in different scenarios. For shipped versions (e.g. **v1.6.0**, **v1.7.0**, **v1.8.0**, **v1.8.1**), see [CHANGELOG.md](CHANGELOG.md).
